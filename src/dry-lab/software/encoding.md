...
Given a set of requirements, create primers that the wet lab can use for synthesizing ssDNA with TdT. Additionally, demonstrate that our data storage model will not run out of primers, and that we can create more primers to append/make edits to preexisting files.
...
* Fitness function determined by constraints, each having a weight or “acceptable” range
    ...
    * For initial determining melting temperature: https://www.addgene.org/protocols/primer-design/
    * For initial determining if secondary structures will form:
...
1. To conserve bases for encoding information or error correcting codes, compression of some format will occur
    1. Text compression algorithms:
        ...
        4. LZ4: [https://github.com/lz4/lz4](https://github.com/lz4/lz4)
            1. Optimized for speed
        5. [https://en.wikipedia.org/wiki/Lempel%E2%80%93Ziv%E2%80%93Markov_chain_algorithm](https://en.wikipedia.org/wiki/Lempel%E2%80%93Ziv%E2%80%93Markov_chain_algorithm)
        6. [https://en.wikipedia.org/wiki/Bzip2](https://en.wikipedia.org/wiki/Bzip2)
        7. https://stephane.lesimple.fr/blog/lzop-vs-compress-vs-gzip-vs-bzip2-vs-lzma-vs-lzma2xz-benchmark-reloaded/#results-ordered-by-compression-ratio
